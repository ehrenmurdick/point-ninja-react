...
/***/ function(module, exports, __webpack_require__) {
	...
	var _voting = __webpack_require__(70);
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(
	    'div',
	    null,
	    React.createElement(_voting.Voting, null)
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Voting = undefined;

	var _reactRedux = __webpack_require__(53);

	var _vote = __webpack_require__(71);
	...
	var mapToDispatch = function mapToDispatch(dispatch) {
	  return {
	    vote: function vote() {
	      return dispatch((0, _vote.Vote)(2));
	    }
	  };
	};

	var Voting = exports.Voting = (0, _reactRedux.connect)(mapToProps, mapToDispatch)(view);
...
/***/ function(module, exports) {
	...
	var VoteAction = exports.VoteAction = 'VOTE';

	var Vote = exports.Vote = function Vote(n) {
	  return {
	    type: VoteAction,
	    points: n
	  };
